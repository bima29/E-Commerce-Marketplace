...
@section('content')
            ...
            <div class="relative z-10">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-primary-100 max-w-2xl">Perbarui data toko seller dengan mengubah formulir di bawah ini.</p>
                    </div>
        ...
        <div class="mb-8 pb-6 border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Perbarui data toko untuk seller</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="group">
                        ...
                        <div class="mt-3 space-y-2">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-xs text-gray-600">Aktif: Toko dapat beroperasi</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-gray-400"></div>
                                <span class="text-xs text-gray-600">Nonaktif: Toko tidak dapat beroperasi</span>
                            </div>
                        </div>
                    </div>
    ...
    <div class="bg-primary-50 border border-primary-100 rounded-2xl p-6 mb-6">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                <h3 class="font-semibold text-primary-900 mb-2">Tips Update Seller</h3>
                <ul class="space-y-2 text-sm text-gray-700">
                    <li class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary-900 mt-1.5"></div>
                        <span>Pastikan email tetap aktif agar seller bisa menerima notifikasi</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary-900 mt-1.5"></div>
                        <span>Isi password hanya jika ingin mereset password login seller</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary-900 mt-1.5"></div>
                        <span>Jika status Nonaktif, toko tidak akan tampil/beroperasi seperti biasa</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            passwordInputs.forEach(input => {
                ...
                const eyeIcon = parent ? parent.querySelector('svg') : null;
