...
@section('content')
            ...
            <div class="relative z-10">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-primary-100 max-w-2xl">Perbarui data produk dan (jika perlu) pindahkan ke seller lain.</p>
                    </div>
        ...
        <div class="mb-8 pb-6 border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Perbarui data produk di bawah ini</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ $updateAction }}" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div class="space-y-6">
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            <select name="seller_id" class="mt-1 w-full rounded-lg border-gray-300 focus:border-primary-900 focus:ring-2 focus:ring-primary-900/20 px-4 py-3 appearance-none transition-all duration-200 group-hover:border-primary-500">
                        ...
                        <p class="mt-2 text-xs text-gray-500">Produk akan terhubung ke toko seller yang dipilih</p>
                    </div>
                </div>
    ...
    <div class="bg-primary-50 border border-primary-100 rounded-2xl p-6 mb-6">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                <h3 class="font-semibold text-primary-900 mb-2">Tips Update Produk</h3>
                <ul class="space-y-2 text-sm text-gray-700">
                    <li class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary-900 mt-1.5"></div>
                        <span>Pastikan harga &gt; 0 dan stok tidak negatif</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary-900 mt-1.5"></div>
                        <span>Jika mengganti seller, pastikan seller tujuan berstatus aktif</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary-900 mt-1.5"></div>
                        <span>Gunakan image URL yang valid agar gambar dapat dimuat</span>
                    </li>
                </ul>
            </div>
        </div>
