...
@section('content')
    @php
        $storeAction = \Illuminate\Support\Facades\Route::has('superadmin.products.store')
            ...
            <div class="relative z-10">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-primary-100 max-w-2xl">Buat produk baru dan tentukan seller yang memiliki produk tersebut.</p>
                    </div>
        ...
        <div class="mb-8 pb-6 border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Lengkapi data produk dan pilih seller</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="relative">
                            <select name="seller_id" class="mt-1 w-full rounded-lg border-gray-300 focus:border-primary-900 focus:ring-2 focus:ring-primary-900/20 px-4 py-3 appearance-none transition-all duration-200 group-hover:border-primary-500">
                                ...
                                @foreach (($sellers ?? []) as $seller)
                                    <option value="{{ $seller->id }}" {{ (string)old('seller_id') === (string)$seller->id ? 'selected' : '' }}>
